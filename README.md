...
<!-- Intro Summary -->
<h4 align="center">I'm a 3D/Technical Artist working in the Industry, always keen to learn more about Tools, Systems Design and Algorithms! Coding something into reality spurs a sort of inexplicale happiness, especially when others beneift from it. I've started with Python but I am now working my way through proper Algorithms and Data Structures, Rust and Bash/Zsh!</h4>
...
| Category | Software |
| - | - |
| **OS's**| [![Windows 11](https://img.shields.io/badge/Windows-gray?style=flat&logo=square&logoColor=blue&color=gray)](https://www.microsoft.com/software-download/windows11) [![MacOS](https://img.shields.io/badge/MacOS-343434?style=flat&logo=apple&logoColor=white)](https://support.apple.com/downloads/macos) [![CachyOS](https://img.shields.io/badge/CachyOS-1793D1?style=flat&logo=arch-linux&logoColor=white)](https://cachyos.org/) |
**Editors**| [![IntelliJ PyCharm](https://img.shields.io/badge/IntelliJ_PyCharm-PyCharm?style=flat&logo=pycharm&logoColor=black)](https://www.jetbrains.com/pycharm/download/) [![VS Code](https://img.shields.io/badge/VSCode-vscode?style=flat&logo=visual-studio-code&logoColor=blue&color=gray)](https://code.visualstudio.com/) |
**Comfortable**| [![Python3](https://img.shields.io/badge/Python-python?style=flat&logo=python&color=yellow)](https://www.python.org/) [![Markdown](https://img.shields.io/badge/Markdown-1b1b1b?style=flat&logo=markdown&logoColor=white)](https://en.wikipedia.org/wiki/Markdown) |
**Learning**| [![Rust](https://img.shields.io/badge/Rust-orange?style=flat&logo=rust&color=red)](https://www.rust-lang.org/) [![Sqlite](https://img.shields.io/badge/Sqlite-white?style=flat&logo=sqlite&logoColor=blue)](https://www.sqlite.org/index.html) [![Git](https://img.shields.io/badge/Git-E44C30?style=flat&logo=git&logoColor=white)](https://git-scm.com/) [![ZSH](https://img.shields.io/badge/Zsh-zsh?style=flat&logo=zsh&logoColor=black)](https://github.com/ohmyzsh/ohmyzsh/wiki/Installing-ZSH) [![Bash](https://img.shields.io/static/v1?label=&message=Bash&color=4EAA25&logo=gnubash&logoColor=FFFFFF)](https://www.gnu.org/software/bash/) |
...
<!-- Metrics -->
<details open>
  <summary><b>📊 Metrics (Includes private repositories)</b></summary>
    <p>
